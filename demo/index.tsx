  ...
  render() {
    ...
    return (
      <div className={classes.container}>
        <DateFormatInput disabled name='date-input' value={date} onChange={this.onChangeDate} min={min} max={max} label='Date' okToConfirm/>
        <TimeFormatInput disabled name='time-input' value={time} onChange={this.onChangeTime} label='Time' selectableMinutesInterval={5} dialog okToConfirm/>
      </div>
    )
  }
}
